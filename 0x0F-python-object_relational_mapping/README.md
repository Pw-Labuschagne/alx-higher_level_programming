Here we start with python object relational mappinng. SO they say no more sql queries, sounds like fun but won't this be harder? Lets find out the task are:
